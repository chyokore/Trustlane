  ...
  return (
    <>
      <button
        ...
        className="fixed left-4 top-4 z-[60] grid size-10 place-items-center rounded-lg border border-border bg-card text-foreground lg:hidden"
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-[60] flex w-72 flex-col border-r border-border bg-background p-5 transition-transform duration-300 lg:translate-x-0",
        ...
        <div className="border-t border-border pt-4">
          ...
          <div className="mt-4 rounded-xl border border-primary/15 bg-primary/5 p-4">
            ...
            <p className="mt-1 text-xs leading-5 text-muted-foreground">
              Every decision stays clear and in your control.
            </p>
          </div>
        </div>
      </aside>
