...
export function VerifiedSensoContext({ context }: { context?: VerifiedMerchantContext }) {
  ...
  return (
    <section aria-label="Verified by Senso" className="rounded-xl border border-primary/20 bg-primary/5 p-4">
      ...
      <p className="mt-2 text-sm leading-6 text-muted-foreground">{unavailable ? "Verified context temporarily unavailable." : context.groundedAnswer}</p>
