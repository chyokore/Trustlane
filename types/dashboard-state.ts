...
export interface HostedCheckoutSession { sessionId: string; orderId?: string; merchant: string; product: string; amount: string; currency: string; decisionLedgerId: string; createdAt: string; expiresAt?: string; }
